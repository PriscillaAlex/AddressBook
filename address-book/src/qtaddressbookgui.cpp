...
void QtAddressBookGUI::createWidgets()
{
    ...
    newContactButton -> setStyleSheet("*{ background-color: rgb(150,200,120)}");
    editContactButton = new QPushButton("Edit");
    editContactButton-> setStyleSheet("*{ background-color: rgb(200,200,120)}");
    deleteContactButton = new QPushButton("Delete");
    deleteContactButton-> setStyleSheet("*{ background-color: rgb(120,200,200)}");
    searchContactButton = new QPushButton("Search");
    searchContactButton-> setStyleSheet("*{ background-color: rgb(120,120,200)}");
